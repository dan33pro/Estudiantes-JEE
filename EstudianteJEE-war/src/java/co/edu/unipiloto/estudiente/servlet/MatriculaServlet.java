...
import co.edu.unipiloto.estudiante.entity.Matricula;
...
import co.edu.unipiloto.estudiante.session.MatriculaFacadeLocal;
...
public class MatriculaServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        int id;
        try {
            id = Integer.parseInt(request.getParameter("estID"));
        } catch (Exception e) {
            id = -1;
        }
        ...
        Matricula matricula = new Matricula(codCurso, id);
        switch (action) {
            case "Delete":
        ...
        request.setAttribute("allStuds", estudianteFacade.findAll());
        request.setAttribute("allMatri", matriculaFacade.findAll());
